...
FEED_URL=${2:-"https://raw.githubusercontent.com/autolab/autolab/main/appcast.xml"}
...
DOWNLOAD_URL_PREFIX=${SPARKLE_DOWNLOAD_URL_PREFIX:-"https://github.com/autolab/autolab/releases/download/v${VERSION}/"}
