...
- Keep product names in English: AutoLab, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the AutoLab Gateway, use “Gateway 网关”.
