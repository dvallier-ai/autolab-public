...
if [[ -z "$version_content" ]]; then
  echo "<h2>AutoLab $VERSION</h2>"
  echo "<p>Latest AutoLab update.</p>"
  echo "<p><a href=\"https://github.com/danv-intel/autolab/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
