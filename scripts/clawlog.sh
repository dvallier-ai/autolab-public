...
show_usage() {
    cat << EOF
clawlog - AutoLab Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View AutoLab logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    AutoLab logs flow through the macOS unified log (subsystem: ai.autolab).
