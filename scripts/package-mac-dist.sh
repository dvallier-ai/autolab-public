...
# Output:
# - dist/AutoLab.app
# - dist/AutoLab-<version>.zip
# - dist/AutoLab-<version>.dmg
...
ZIP="$ROOT_DIR/dist/AutoLab-$VERSION.zip"
DMG="$ROOT_DIR/dist/AutoLab-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/AutoLab-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/AutoLab-$VERSION.dSYM.zip"
