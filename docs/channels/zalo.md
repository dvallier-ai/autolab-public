...
- Install via CLI: `autolab plugins install @autolab/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `autolab plugins install ./extensions/zalo`
   - From npm (if published): `autolab plugins install @autolab/zalo`
...
- Approve via:
  - `autolab pairing list zalo`
  - `autolab pairing approve zalo <CODE>`
...
- Example: `autolab message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `autolab channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `autolab logs --follow`
