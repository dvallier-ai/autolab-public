...
This guide summarizes a sane workflow for working on the pi integration in AutoLab.
...
- Trigger the agent directly:
  - `pnpm autolab agent --message "Hello" --thinking low`
...
State lives under the AutoLab state directory. Default is `~/.autolab`. If `AUTOLAB_STATE_DIR` is set, use that directory instead.

To reset everything:

- `autolab.json` for config
...
- [https://dvallier-ai.github.io/autolab-public/testing](https://dvallier-ai.github.io/autolab-public/testing)
- [https://dvallier-ai.github.io/autolab-public/start/getting-started](https://dvallier-ai.github.io/autolab-public/start/getting-started)
