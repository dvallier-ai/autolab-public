---
summary: "AutoNet refactor: unify network protocol, roles, auth, approvals, identity"
read_when:
...
title: "AutoNet Refactor"
---

# AutoNet refactor (protocol + auth unification)
...
- Example: `scarlet-lab`, `saltwave`, `mantis-pinch`.
