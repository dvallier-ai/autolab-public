...
AutoLab treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.autolab/settings/voicewake.json`

Shape:

```json
{ "triggers": ["autolab", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
