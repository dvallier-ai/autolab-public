...
- [Quick start and first-run setup]
  ...
  - [I can't access docs.autolab.ai (SSL error). What now?](#i-cant-access-docsautolabai-ssl-error-what-now)
...
```bash
curl -fsSL https://autolab.ai/install.sh | bash -s -- --install-method git
```
...
### I cant access docs.autolab.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.autolab.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.autolab.ai`, then retry. More
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://autolab.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://autolab.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://autolab.ai/install.ps1](https://autolab.ai/install.ps1)
...
```bash
curl -fsSL https://autolab.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://autolab.ai/install.sh | bash -s -- --beta --verbose
```
...
Showcase: [https://autolab.ai/showcase](https://autolab.ai/showcase)
