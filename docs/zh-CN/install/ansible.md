...
将 AutoLab 部署到生产服务器的推荐方式是通过 **[autolab-ansible](https://github.com/openclaw/openclaw-ansible)** — 一个安全优先架构的自动化安装程序。
...
- [autolab-ansible](https://github.com/openclaw/openclaw-ansible) — 完整部署指南
