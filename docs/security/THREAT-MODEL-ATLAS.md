...
This threat model documents adversarial threats to the AutoLab AI agent platform and ClawHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.
...
| **ClawHub**          | AutoLab's skill marketplace                              |
...
_This threat model is a living document. Report security issues to security@dvallier-ai.github.io/autolab-public_
