...
This is a living document maintained by the AutoLab community. See [CONTRIBUTING-THREAT-MODEL.md](./CONTRIBUTING-THREAT-MODEL.md) for guidelines on contributing:
...
This threat model documents adversarial threats to the AutoLab AI agent platform and AutoHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component             | Included | Notes                                            |
| --------------------- | -------- | ------------------------------------------------ |
| AutoLab Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
| Gateway               | Yes      | Authentication, routing, channel integration     |
| Channel Integrations  | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| AutoHub Marketplace   | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | AutoHub | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed AutoLab gateway endpoints                 |
...
| **Affected Components** | ~/.autolab/credentials/, config storage                     |
...
| **Description**         | Attacker publishes malicious skill to AutoHub                            |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | AutoHub, skill loading, agent execution                                  |
...
| **Affected Components** | AutoHub versioning, auto-update flows                          |
...
| **Affected Components** | AutoHub moderation.ts                                                  |
...
## 4. AutoHub Supply Chain Analysis
...
/(keepcold131\/AutoLabAuthenticatorTool|AutoLabAuthenticatorTool)/i
...
| ATLAS ID      | Technique Name                 | AutoLab Threats                                                  |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| `convex/lib/moderation.ts`          | AutoHub moderation          | **High**     |
...
| **AutoHub**          | AutoLab's skill marketplace                               |
| **Gateway**          | AutoLab's message routing and authentication layer        |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for AutoLab agents                 |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@autolab.ai_
