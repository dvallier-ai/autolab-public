...
- Which parts of AutoLab are affected (CLI, gateway, channels, AutoHub, MCP servers, etc.)
- How severe you think it is (low / medium / high / critical)
- Any links to related research, CVEs, or real-world examples

We'll handle the ATLAS mapping, threat IDs, and risk assessment during review. If you want to include those details, great - but it's not expected.

> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, see our [Trust page](https://trust.autolab.ai) for responsible disclosure instructions.
...
- **Security vulnerabilities:** See our [Trust page](https://trust.autolab.ai) for reporting instructions
