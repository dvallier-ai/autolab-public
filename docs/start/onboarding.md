---
summary: "First-run onboarding flow for AutoLab (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give AutoLab">
...
<Step title="CLI">
  ...
  The app can install the global `autolab` CLI via npm/pnpm so terminal
