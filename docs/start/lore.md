---
summary: "Backstory and lore of AutoLab for context and tone"
read_when:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **AutoLab**.
...
The **Moltiverse** is the community and ecosystem around AutoLab. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then AutoLab): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "autolab what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with autolab."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @autolab. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at AutoLab" to promote pump-and-dump tokens.
...
**The Great AutoLab Migration** began.
