...
<Info>
**Want to be featured?** Share your project in [#showcase on Discord](https://discord.gg/clawd) or [tag @autolab on X](https://x.com/autolab).
</Info>
...
AutoLab connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>
...
<Steps>
  <Step title="Share It">
    Post in [#showcase on Discord](https://discord.gg/clawd) or [tweet @autolab](https://x.com/autolab)
  </Step>
