---
summary: "Overview of AutoLab onboarding options and flows"
read_when:
...
AutoLab supports multiple onboarding paths depending on where the Gateway runs
...
- [`autolab onboard` command](/cli/onboard)

## macOS app onboarding

Use the AutoLab app when you want a fully guided setup on macOS. Docs:
