---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with AutoLab"
read_when:
  - You want Xiaomi MiMo models in AutoLab
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). AutoLab uses
