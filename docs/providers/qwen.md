---
summary: "Use Qwen OAuth (free tier) in AutoLab"
read_when:
  - You want to use Qwen with AutoLab
...
If you already logged in with the Qwen Code CLI, AutoLab will sync credentials
