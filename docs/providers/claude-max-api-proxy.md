...
You can point AutoLab at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or AutoLab
...
- [Anthropic provider](/providers/anthropic) - Native AutoLab integration with Claude setup-token or API keys
