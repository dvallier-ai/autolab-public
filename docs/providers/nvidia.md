---
summary: "Use NVIDIA's OpenAI-compatible API in AutoLab"
read_when:
  - You want to use NVIDIA models in AutoLab
...
autolab onboard --auth-choice skip
autolab models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
