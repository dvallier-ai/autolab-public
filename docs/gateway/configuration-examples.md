---
summary: "Schema-accurate configuration examples for common AutoLab setups"
read_when:
  - Learning how to configure AutoLab
...
```json5
{
  agent: { workspace: "~/.autolab/workspace" },
