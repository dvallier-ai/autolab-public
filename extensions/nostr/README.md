...
Nostr DM channel plugin for AutoLab using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to AutoLab. It enables your bot to:
...
# Configure autolab to use local relay
