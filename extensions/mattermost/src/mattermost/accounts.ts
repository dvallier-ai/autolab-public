...
export function listMattermostAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: AutoLabConfig): string {
...
export function listEnabledMattermostAccounts(cfg: AutoLabConfig): ResolvedMattermostAccount[] {
