...
export function listGoogleChatAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: AutoLabConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: AutoLabConfig): ResolvedGoogleChatAccount[] {
