...
export function listZaloAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: AutoLabConfig): string {
...
function mergeZaloAccountConfig(cfg: AutoLabConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AutoLabConfig): ResolvedZaloAccount[] {
