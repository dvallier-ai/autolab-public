...
import { resolveChannelMediaMaxBytes, type AutoLabConfig } from "autolab/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: AutoLabConfig; accountId?: string }): string[] {
