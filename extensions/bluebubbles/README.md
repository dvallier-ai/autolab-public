...
This directory contains the **BlueBubbles external channel plugin** for AutoLab.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `autolab/plugin-sdk` helpers.
