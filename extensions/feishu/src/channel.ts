import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "autolab/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "autolab/plugin-sdk";
