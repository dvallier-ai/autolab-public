...
import type { ReplyPayload, AutoLabConfig } from "autolab/plugin-sdk";
import { createReplyPrefixOptions } from "autolab/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as AutoLabConfig;
