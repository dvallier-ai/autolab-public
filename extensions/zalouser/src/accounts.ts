...
export function listZalouserAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: AutoLabConfig): string {
...
function mergeZalouserAccountConfig(cfg: AutoLabConfig, accountId: string): ZalouserAccountConfig {
