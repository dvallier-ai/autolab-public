...
describe("createAutoLabCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAutoLabCodingTools({
      config,
    ...
    const anthropicTools = createAutoLabCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAutoLabCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAutoLabCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
