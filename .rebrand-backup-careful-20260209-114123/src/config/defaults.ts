...
function resolveAnthropicDefaultAuthMode(cfg: AutoLabConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyTalkApiKey(config: AutoLabConfig): AutoLabConfig {
...
export function applyModelDefaults(cfg: AutoLabConfig): AutoLabConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyLoggingDefaults(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyContextPruningDefaults(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyCompactionDefaults(cfg: AutoLabConfig): AutoLabConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
