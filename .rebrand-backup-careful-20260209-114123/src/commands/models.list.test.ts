...
const ensureAutoLabModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveAutoLabAgentDir = vi.fn().mockReturnValue("/tmp/autolab-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/autolab-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureAutoLabModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveAutoLabAgentDir,
}));
