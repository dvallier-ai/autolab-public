...
This directory contains hooks that ship with AutoLab. These hooks are automatically discovered and can be enabled/disabled via CLI or configuration.
...
2. Restart gateway: `pkill -9 -f 'autolab.*gateway' && pnpm autolab gateway`
3. Enable the hook: `autolab hooks enable my-hook`
