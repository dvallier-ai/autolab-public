...
import { createAutoLabTools } from "../agents/autolab-tools.js";
...
beforeAll(async () => {
  ...
  process.env.AUTOLAB_GATEWAY_PORT = String(gatewayPort);
  process.env.AUTOLAB_GATEWAY_TOKEN = "test-token";
...
describe("sessions_send gateway loopback", () => {
  it("returns reply when lifecycle ends before agent.wait", async () => {
    ...
    const tool = createAutoLabTools().find((candidate) => candidate.name === "sessions_send");
    if (!tool) {
