...
import type { AutoLabPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AutoLabPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AutoLabPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
