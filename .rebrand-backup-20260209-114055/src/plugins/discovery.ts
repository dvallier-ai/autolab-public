...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @autolab/voice-call -> voice-call).
...
export function discoverAutoLabPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".autolab", "extensions")];
