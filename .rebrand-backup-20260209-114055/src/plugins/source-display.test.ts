...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/autolab/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/autolab/extensions",
        global: "/Users/x/.autolab/extensions",
        workspace: "/Users/x/ws/.autolab/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.autolab/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/autolab/extensions",
        global: "/Users/x/.autolab/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.autolab/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/autolab/extensions",
        global: "/Users/x/.autolab/extensions",
