...
// pi-ai's built-in Anthropic catalog can lag behind AutoLab's defaults/docs.
...
export function buildModelAliasLines(cfg?: AutoLabConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAutoLabAgentDir();
