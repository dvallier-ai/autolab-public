...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@autolab", { botUsername: "autolab" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@autolab args", {
        botUsername: "autolab",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "autolab" })).toBe(
      "/help@otherbot",
    );
  });
