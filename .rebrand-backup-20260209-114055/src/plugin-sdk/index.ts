...
export type { AutoLabConfig } from "../config/config.js";
/** @deprecated Use AutoLabConfig instead */
export type { AutoLabConfig as ClawdbotConfig } from "../config/config.js";
