...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.AUTOLAB_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AutoLabConfig): string {
...
function mergeTelegramAccountConfig(cfg: AutoLabConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AutoLabConfig): ResolvedTelegramAccount[] {
