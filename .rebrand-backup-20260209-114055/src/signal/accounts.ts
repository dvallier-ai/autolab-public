...
export function listSignalAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: AutoLabConfig): string {
...
function mergeSignalAccountConfig(cfg: AutoLabConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AutoLabConfig): ResolvedSignalAccount[] {
