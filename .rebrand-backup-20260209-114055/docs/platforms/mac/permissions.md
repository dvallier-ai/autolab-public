...
- Same path: run the app from a fixed location (for AutoLab, `dist/AutoLab.app`).
...
Workaround: move files into the AutoLab workspace (`~/.autolab/workspace`) if you want to avoid per-folder grants.
