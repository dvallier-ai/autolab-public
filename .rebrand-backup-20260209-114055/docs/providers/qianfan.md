---
summary: "Use Qianfan's unified API to access many models in AutoLab"
read_when:
...
3. AutoLab installed on your system
...
4. Copy the API key for use with AutoLab

## CLI setup

```bash
autolab onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [AutoLab Configuration](/gateway/configuration)
