...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/danv-intel/autolab/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.AUTOLAB_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.autolab/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: AutoLabConfig = {
    ...params.cfg,
