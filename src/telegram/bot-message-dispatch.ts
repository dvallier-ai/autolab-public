...
import type { AutoLabConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: AutoLabConfig, agentId: string) {
  try {
