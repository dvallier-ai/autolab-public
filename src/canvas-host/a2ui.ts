...
export const A2UI_PATH = "/__autolab__/a2ui";

export const CANVAS_HOST_PATH = "/__autolab__/canvas";

export const CANVAS_WS_PATH = "/__autolab__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.autolabCanvasA2UIAction.postMessage(...)
  // - Android: window.autolabCanvasA2UIAction.postMessage(...)
  const handlerNames = ["autolabCanvasA2UIAction"];
  ...
  globalThis.AutoLab = globalThis.AutoLab ?? {};
  globalThis.AutoLab.postMessage = postToNode;
  globalThis.AutoLab.sendUserAction = sendUserAction;
  globalThis.autolabPostMessage = postToNode;
  globalThis.autolabSendUserAction = sendUserAction;
