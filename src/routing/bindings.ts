...
export function listBindings(cfg: AutoLabConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: AutoLabConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AutoLabConfig) {
