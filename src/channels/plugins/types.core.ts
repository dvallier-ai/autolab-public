...
export type ChannelAgentToolFactory = (params: { cfg?: AutoLabConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AutoLabConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AutoLabConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AutoLabConfig }) => boolean;
  supportsCards?: (params: { cfg: AutoLabConfig }) => boolean;
