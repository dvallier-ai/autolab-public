...
export const DEFAULT_SANDBOX_IMAGE = "autolab-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "autolab-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "autolab-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "autolab-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "autolab-sbx-browser-";
