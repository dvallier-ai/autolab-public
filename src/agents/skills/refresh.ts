...
function resolveWatchPaths(workspaceDir: string, config?: AutoLabConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AutoLabConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AutoLabConfig }) {
