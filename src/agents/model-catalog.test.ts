...
vi.mock("./models-config.js", () => ({
  ensureAutoLabModelsJson: vi.fn().mockResolvedValue({ agentDir: "/tmp", wrote: false }),
}));

vi.mock("./agent-paths.js", () => ({
  resolveAutoLabAgentDir: () => "/tmp/autolab",
}));
...
describe("loadModelCatalog", () => {
  ...
  it("returns partial results on discovery errors", async () => {
    ...
    const result = await loadModelCatalog({ config: {} as AutoLabConfig });
