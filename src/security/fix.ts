...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AutoLabConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AutoLabConfig; env: NodeJS.ProcessEnv }): {
  cfg: AutoLabConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
