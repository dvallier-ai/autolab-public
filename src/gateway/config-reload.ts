...
import type { AutoLabConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: AutoLabConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: AutoLabConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: AutoLabConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: AutoLabConfig) => void;
  log: {
