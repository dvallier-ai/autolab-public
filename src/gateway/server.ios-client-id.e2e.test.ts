...
beforeAll(async () => {
  previousToken = process.env.AUTOLAB_GATEWAY_TOKEN;
  process.env.AUTOLAB_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
afterAll(async () => {
  ...
  if (previousToken === undefined) {
    ...
    process.env.AUTOLAB_GATEWAY_TOKEN = previousToken;
  }
});
...
test.each([
  { clientId: "autolab-ios", platform: "ios" },
  { clientId: "autolab-android", platform: "android" },
