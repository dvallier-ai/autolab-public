...
export function applyOpenrouterProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AutoLabConfig): AutoLabConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyMoonshotConfig(cfg: AutoLabConfig): AutoLabConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AutoLabConfig): AutoLabConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AutoLabConfig): AutoLabConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AutoLabConfig): AutoLabConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AutoLabConfig): AutoLabConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AutoLabConfig): AutoLabConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AutoLabConfig): AutoLabConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AutoLabConfig): AutoLabConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyQianfanProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AutoLabConfig): AutoLabConfig {
