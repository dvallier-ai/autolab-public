...
type PromptDefaultModelResult = { model?: string; config?: AutoLabConfig };
...
function resolveConfiguredModelRaw(cfg: AutoLabConfig): string {
...
function resolveConfiguredModelKeys(cfg: AutoLabConfig): string[] {
...
export function applyPrimaryModel(cfg: AutoLabConfig, model: string): AutoLabConfig {
...
export function applyModelAllowlist(cfg: AutoLabConfig, models: string[]): AutoLabConfig {
  const defaults = cfg.agents?.defaults;
