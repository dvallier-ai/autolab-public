...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.autolab.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("autolab hooks list")}`,
      `  ${formatCliCommand("autolab hooks enable <name>")}`,
      `  ${formatCliCommand("autolab hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
