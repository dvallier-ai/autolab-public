...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "autolab-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<AutoLabConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<AutoLabConfig["telegram"]>>,
