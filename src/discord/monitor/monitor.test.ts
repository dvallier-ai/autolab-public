...
describe("agent components", () => {
  const createCfg = (): AutoLabConfig => ({}) as AutoLabConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/autolab-sessions-test.json");
  });
