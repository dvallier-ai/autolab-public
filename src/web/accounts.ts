...
function listConfiguredAccountIds(cfg: AutoLabConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: AutoLabConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AutoLabConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: AutoLabConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: AutoLabConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AutoLabConfig): ResolvedWhatsAppAccount[] {
