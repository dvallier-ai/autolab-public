...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayToken = process.env.AUTOLAB_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.AUTOLAB_GATEWAY_PASSWORD;
  ...
  afterEach(async () => {
    ...
    if (prevGatewayToken === undefined) {
      ...
      process.env.AUTOLAB_GATEWAY_TOKEN = prevGatewayToken;
    }
    if (prevGatewayPassword === undefined) {
      delete process.env.AUTOLAB_GATEWAY_PASSWORD;
    } else {
      process.env.AUTOLAB_GATEWAY_PASSWORD = prevGatewayPassword;
    }
