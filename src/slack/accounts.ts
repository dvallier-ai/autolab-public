...
export function listSlackAccountIds(cfg: AutoLabConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: AutoLabConfig): string {
...
function mergeSlackAccountConfig(cfg: AutoLabConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AutoLabConfig): ResolvedSlackAccount[] {
