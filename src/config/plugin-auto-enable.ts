import type { AutoLabConfig } from "./config.js";
...
function isTelegramConfigured(cfg: AutoLabConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: AutoLabConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: AutoLabConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: AutoLabConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: AutoLabConfig): boolean {
...
function isIMessageConfigured(cfg: AutoLabConfig): boolean {
...
function isWhatsAppConfigured(cfg: AutoLabConfig): boolean {
...
function isGenericChannelConfigured(cfg: AutoLabConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: AutoLabConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: AutoLabConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: AutoLabConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: AutoLabConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: AutoLabConfig, pluginId: string): AutoLabConfig {
...
function registerPluginEntry(cfg: AutoLabConfig, pluginId: string): AutoLabConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
