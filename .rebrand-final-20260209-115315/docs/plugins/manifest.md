...
read_when:
  - You are building a AutoLab plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (autolab.plugin.json)

Every plugin **must** ship a `autolab.plugin.json` file in the **plugin root**.
AutoLab uses this manifest to validate configuration **without executing plugin
