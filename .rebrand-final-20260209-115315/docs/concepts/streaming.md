...
AutoLab has two separate “streaming” layers:
...
When block streaming is enabled, AutoLab can **merge consecutive block chunks**
...
When draft streaming is active, AutoLab disables block streaming for that reply to avoid double-streaming.
