---
summary: "Use Synthetic's Anthropic-compatible API in AutoLab"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. AutoLab registers it as the
...
Note: AutoLab's Anthropic client appends `/v1` to the base URL, so use
