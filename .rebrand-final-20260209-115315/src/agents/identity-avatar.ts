...
function resolveAvatarSource(cfg: AutoLabConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AutoLabConfig, agentId: string): AgentAvatarResolution {
