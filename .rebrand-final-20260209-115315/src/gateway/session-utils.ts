...
import { type AutoLabConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AutoLabConfig): string[] {
...
export function listAgentsForGateway(cfg: AutoLabConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AutoLabConfig): string {
...
function resolveSessionStoreAgentId(cfg: AutoLabConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: AutoLabConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: AutoLabConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: AutoLabConfig): GatewaySessionsDefaults {
