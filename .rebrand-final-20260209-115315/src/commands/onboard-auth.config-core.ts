...
export function applyZaiConfig(cfg: AutoLabConfig): AutoLabConfig {
...
export function applyVercelAiGatewayProviderConfig(cfg: AutoLabConfig): AutoLabConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: AutoLabConfig): AutoLabConfig {
