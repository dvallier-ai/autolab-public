...
import type { GatewayBindMode, GatewayTailscaleMode, AutoLabConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.autolab.ai/gateway/tailscale", "https://docs.autolab.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
