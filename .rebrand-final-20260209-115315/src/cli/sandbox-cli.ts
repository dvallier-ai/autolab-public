...
const SANDBOX_EXAMPLES = {
  main: [
    ["autolab sandbox list", "List all sandbox containers."],
    ["autolab sandbox list --browser", "List only browser containers."],
    ["autolab sandbox recreate --all", "Recreate all containers."],
    ["autolab sandbox recreate --session main", "Recreate a specific session."],
    ["autolab sandbox recreate --agent mybot", "Recreate agent containers."],
    ["autolab sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["autolab sandbox list", "List all sandbox containers."],
    ["autolab sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["autolab sandbox recreate --all", "Recreate all containers."],
    ["autolab sandbox recreate --session main", "Recreate a specific session."],
    ["autolab sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["autolab sandbox recreate --browser --all", "Recreate only browser containers."],
    ["autolab sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["autolab sandbox explain", "Show effective sandbox config."],
    ["autolab sandbox explain --session agent:main:main", "Explain a specific session."],
    ["autolab sandbox explain --agent work", "Explain an agent sandbox."],
    ["autolab sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.autolab.ai/cli/sandbox")}\n`,
    )
    .action(() => {
