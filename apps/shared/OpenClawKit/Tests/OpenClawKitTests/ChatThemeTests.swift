...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = AutoLabChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = AutoLabChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
