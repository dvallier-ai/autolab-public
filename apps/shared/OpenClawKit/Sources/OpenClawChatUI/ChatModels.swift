...
public typealias AutoLabPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AutoLabPlatformImage = UIImage
#endif

public struct AutoLabChatUsageCost: Codable, Hashable, Sendable {
...
public struct AutoLabChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AutoLabChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AutoLabChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AutoLabChatMessageContent: Codable, Hashable, Sendable {
...
public struct AutoLabChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AutoLabChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AutoLabChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AutoLabChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AutoLabChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AutoLabChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AutoLabChatMessageContent].self, forKey: .content) {
...
public struct AutoLabChatHistoryPayload: Codable, Sendable {
...
public struct AutoLabSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AutoLabSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AutoLabSessionPreviewItem]
}

public struct AutoLabSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AutoLabSessionPreviewEntry]

    public init(ts: Int, previews: [AutoLabSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AutoLabChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AutoLabChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AutoLabAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AutoLabChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AutoLabGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AutoLabPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AutoLabPlatformImage?
...
public struct AutoLabChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
