...
@MainActor
public struct AutoLabChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: AutoLabChatViewModel
    ...
    public init(
        viewModel: AutoLabChatViewModel,
    ...
    private var visibleMessages: [AutoLabChatMessage] {
        let base: [AutoLabChatMessage]
    ...
    private func mergeToolResults(in messages: [AutoLabChatMessage]) -> [AutoLabChatMessage] {
    ...
    private func isToolResultMessage(_ message: AutoLabChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: AutoLabChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: AutoLabChatMessage) -> String {
