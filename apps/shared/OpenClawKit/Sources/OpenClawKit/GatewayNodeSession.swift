...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.autolab", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.autolab", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AutoLabProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
