...
public enum AutoLabCanvasA2UICommand: String, Codable, Sendable {
...
public struct AutoLabCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AutoLabCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
