...
final class ScreenController {
    ...
    /// Callback invoked when an autolab:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = AutoLabKitResources.bundle
...
/// Handles navigation policy to intercept autolab:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept autolab:// deep links.
        if url.scheme?.lowercased() == "autolab" {
