...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.autolab.gateway"
    private static let nodeService = "ai.autolab.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.autolab.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.autolab.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("autolab-gateway.log")
    }
