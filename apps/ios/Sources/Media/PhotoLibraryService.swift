...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AutoLabPhotosLatestParams) async throws -> AutoLabPhotosLatestPayload {
        ...
        var results: [AutoLabPhotoPayload] = []
        ...
        return AutoLabPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AutoLabPhotoPayload
    {
