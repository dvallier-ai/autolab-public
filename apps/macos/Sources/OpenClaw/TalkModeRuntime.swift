...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.autolab", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.autolab", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AutoLabChatMessage] = messages.compactMap { item in
