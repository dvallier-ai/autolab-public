...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.autolab", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("AutoLab/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__autolab__/a2ui/").absoluteString + "?platform=macos"
    }
