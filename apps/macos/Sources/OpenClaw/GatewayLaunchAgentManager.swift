...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.autolab", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".autolab/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.autolabCommand(
            subcommand: "gateway",
