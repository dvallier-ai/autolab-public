...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.autolab", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other AutoLab windows, but below the system’s pop-up menus.
