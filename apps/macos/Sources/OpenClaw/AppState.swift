...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AutoLabConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = AutoLabConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = AutoLabConfigFile.loadDict()
            ...
            AutoLabConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/autolab"
        state.remoteCliPath = ""
        return state
    }
}
