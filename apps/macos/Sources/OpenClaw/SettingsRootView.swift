...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .autolabSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AutoLabPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AutoLabPaths.stateDirURL.path
...
extension Notification.Name {
    static let autolabSelectSettingsTab = Notification.Name("autolabSelectSettingsTab")
}
