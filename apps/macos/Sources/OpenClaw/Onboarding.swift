...
enum UIStrings {
    static let welcomeTitle = "Welcome to AutoLab"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "autolab.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: AutoLabOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: AutoLabChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g autolab@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AutoLabChatViewModel(
