## AutoLab Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_autolab-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm autolab gateway --port 18789 --verbose
```
