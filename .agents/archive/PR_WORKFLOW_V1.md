...
- During `prepare-pr`, use this commit subject format: `fix: <summary> (autolab#<PR>) thanks @<pr-author>`.
...
- Read `docs/help/submitting-a-pr.md` ([Submitting a PR](https://docs.autolab.ai/help/submitting-a-pr)) for what we expect from contributors.
