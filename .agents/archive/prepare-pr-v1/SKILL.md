...
- `fix: <summary> (autolab#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (autolab#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "autolab#$pr_number" || { echo "ERROR: commit subject missing autolab#$pr_number"; exit 1; }
